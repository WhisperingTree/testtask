<?php  return array (
  ...
  'pdotools_prop_sortbyTV' => 'Sort by the TV. If it is not specified in &includeTVs, it will be uncluded automatically.',
  ...
  'pdotools_prop_scheme' => 'Scheme of generation of url, goes to modX::makeUrl().',
