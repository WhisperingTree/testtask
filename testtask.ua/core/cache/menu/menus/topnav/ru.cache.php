  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'parent' => 'components',
        'action' => '1',
        'description' => 'Manage your groups and tags',
        'icon' => '',
        'menuindex' => 0,
        'params' => '',
        'handler' => '',
        ...
        'action_namespace' => 'tagger',
        'id' => 'tagger.menu.tagger',
        'children' => 
        array (
        ),
        'controller' => '',
      ...
      array (
        ...
        'parent' => 'components',
        'action' => '2',
        'description' => 'Компонент для управления комментариями.',
